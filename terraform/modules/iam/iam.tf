...
locals {
  ...
  policy_stmts = {
    ...
    infra_discovery_stmt = [
      ...
      # Ref - https://docs.oracle.com/en-us/iaas/log-analytics/doc/ingest-logs-other-oci-services-using-service-connector.html#LOGAN-GUID-3848C538-28AC-4F53-B3.0-90129278D84F
